...
puts "Hello " + swg_engineer + ", \n\nI have uploaded the " + re + 'submittal ' + full_project_name[0] + " drawing package and report documents to the ENsured website, located under the project folder with the title \"WR " + wr_number + ' ' + full_project_name[1]+full_project_name[2]+full_project_name[3].upcase + submissionx + "\". I have provided the link to the project folder below.\n\n"+ensured_link+"\n\nBased on our field noting, EN Engineering has designed the proposed 2\" PE Main to be installed via"
